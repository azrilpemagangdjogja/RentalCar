                                    ...
                                    <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-600/40">
                                        ...
                                        <td class="px-5 py-4">
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                <form
                                                    action="{{ route('join-pickup-location.addveh', [$pickupLocation->id, $item->id]) }}"
                                                    method="POST"
                                    ...
                                    <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-600/40">
                                        ...
                                        <td class="px-5 py-4 text-right">
                                            <form action="{{ route('join-pickup-location.cancelveh', [$pickupLocation->id, $item->id]) }}"
                                                ...
                                                @method('PATCH')
                                                <button type="submit"
                                                    class="inline-flex items-center gap-1.5 rounded-xl border border-gray-800 px-3 py-2 text-xs font-semibold text-gray-600 transition hover:bg-gray-100 dark:border-gray-500 dark:text-gray-200 dark:hover:bg-gray-600">
                                                    Batalkan
                                                    {{-- <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"
                                                        class="h-3.5 w-3.5">
