...
@section('content')
    <section class="w-full">
        ...
        <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="min-w-0">
                <div class="mb-2 flex items-center gap-2 text-sm text-gray-400 dark:text-gray-500">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-800 dark:text-white sm:text-3xl">Detail Pickup
                        Location</h1>
                    <span
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Informasi lengkap mengenai pickup location,
                    kapasitas, dan kendaraan.</p>
            </div>
        </div>

        {{-- LOCATION HEADER --}}

        <div class="mb-6 rounded-2xl bg-white dark:bg-gray-700">
            <div class="flex flex-col gap-5 p-5 sm:flex-row sm:items-center sm:p-6">
                <div
                    class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gray-100 text-gray-500 dark:bg-gray-600 dark:text-gray-300">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div class="rounded-2xl bg-white p-5 dark:bg-gray-700">
                        <div class="flex items-center justify-between gap-4">
                            <div>
                                <p class="text-xs font-medium text-gray-400 dark:text-gray-500">Kapasitas Maksimum</p>
                ...
                <div class="rounded-2xl bg-white dark:bg-gray-700">
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 p-5 sm:grid-cols-2 sm:p-6">
                        <div class="sm:col-span-2">
                            <p class="text-xs font-medium text-gray-400 dark:text-gray-500">Nama Pickup Location</p>
                            <p class="mt-1 text-sm font-medium text-gray-800 dark:text-white">{{ $pickupLocation->name }}
                            </p>
                        </div>
                        <div class="sm:col-span-2">
                            <p class="text-xs font-medium text-gray-400 dark:text-gray-500">Alamat</p>
                            <p class="mt-1 text-sm leading-6 text-gray-800 dark:text-gray-200">
                                {{ $pickupLocation->address }}</p>
                        </div>
                        <div>
                            <p class="text-xs font-medium text-gray-400 dark:text-gray-500">Latitude</p>
                            <p class="mt-1 text-sm font-medium text-gray-800 dark:text-white">
                                {{ $pickupLocation->latitude }}</p>
                        </div>
                        <div>
                            <p class="text-xs font-medium text-gray-400 dark:text-gray-500">Longitude</p>
                            <p class="mt-1 text-sm font-medium text-gray-800 dark:text-white">
                                {{ $pickupLocation->longitude }}</p>
                        </div>
                        <div>
                            <p class="text-xs font-medium text-gray-400 dark:text-gray-500">Kapasitas</p>
                            <p class="mt-1 text-sm font-medium text-gray-800 dark:text-white">
                                {{ $pickupLocation->max_vehicle }} kendaraan</p>
                        </div>
                        <div>
                            <p class="text-xs font-medium text-gray-400 dark:text-gray-500">Status</p>
                    ...
                    <div class="divide-y divide-gray-100 dark:divide-gray-600">
                        @forelse ($pickupLocation->vehicles as $vehicle)
                            <div class="flex items-center gap-4 p-4 sm:p-5">
                                ...
                                <span
                                    class="hidden shrink-0 rounded-full bg-gray-100 px-2.5 py-1 text-[10px] font-semibold text-gray-600 dark:bg-gray-600 dark:text-gray-200 sm:block">{{ $vehicle->type }}</span>
                            </div>
                        @empty
                            <div class="p-8 text-center">
                                ...
                                <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">Tambahkan kendaraan untuk
                    ...
                    <div class="p-5">
                        ...
                        @if ($pickupLocation->status === 'Active')
                            <form action="{{ route('pickup-location.status', $pickupLocation->id) }}" method="POST">
                                ...
                                <button type="submit"
                                    class="flex w-full items-center justify-center gap-2 rounded-xl bg-gray-100 px-4 py-3 text-sm font-semibold text-gray-700 transition hover:bg-gray-200 dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        @else
                            <form action="" method="POST">
                                ...
                                <button type="submit"
                                    class="flex w-full items-center justify-center gap-2 rounded-xl bg-gray-800 px-4 py-3 text-sm font-semibold text-white transition hover:bg-gray-700 dark:bg-gray-50 dark:text-gray-800 dark:hover:bg-gray-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.8" stroke="currentColor" class="h-5 w-5">
                    ...
                    <div class="space-y-1 p-4">
                        ...
                        <a href=""
                            ...
                            <span class="min-w-0 flex-1">
                                ...
                                <span class="mt-0.5 block text-xs font-normal text-gray-400 dark:text-gray-500">Tambahkan
                        ...
                        <a href=""
                            ...
                            <span class="min-w-0 flex-1">
                                ...
                                <span class="mt-0.5 block text-xs font-normal text-gray-400 dark:text-gray-500">Kapasitas,
                        ...
                        <a href="{{ route('pickup-location.edit', $pickupLocation->id) }}"
                            class="flex w-full items-center gap-3 rounded-xl px-3 py-3 text-left text-sm font-medium text-gray-700 transition hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600">
                            <span
                                class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gray-100 text-gray-500 dark:bg-gray-600 dark:text-gray-300">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            <span class="min-w-0 flex-1">
                                ...
                                <span class="mt-0.5 block text-xs font-normal text-gray-400 dark:text-gray-500">Nama,
