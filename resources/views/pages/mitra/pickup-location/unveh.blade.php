        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500 dark:text-gray-400">
                    Kelola kendaraan milik Anda yang dititipkan di <span
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400 dark:text-gray-400">
                                    Kendaraan yang kamu titipkan di lokasi {{ $pickupLocations->name }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[900px] text-left text-sm">
                            <thead
                                ...
                                <tr>
                                    <th class="px-5 py-4 font-semibold">Kendaraan</th>
                                    <th class="w-[220px] px-5 py-4 font-semibold">Pemilik</th>
                                    <th class="w-[150px] px-5 py-4 font-semibold">Dititipkan</th>
                                    <th class="w-[110px] px-5 py-4 font-semibold">Status</th>
                                    <th class="w-[100px] px-5 py-4 text-right font-semibold">Aksi</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr class="transition hover:bg-gray-100/70 dark:hover:bg-gray-600/50">
                                        ...
                                        <td class="px-5 py-4">
                                            <div class="flex items-center gap-2.5">
                                                <div
                                                    class="h-9 w-9 shrink-0 overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-600">
                                                ...
                                                <div class="min-w-0">
                                                    ...
                                                    <p class="mt-0.5 truncate text-xs text-gray-400 dark:text-gray-400">
                                                        {{ $item->owner?->email ?? '-' }}
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        {{-- ACTION --}}
                                        <td class="px-5 py-4">
                                            <form action="{{ route('join-pickup-location.unveh',[$item->approvalJoin->id, $item->id]) }}" method="POST" class="flex justify-end" onsubmit="return confirm('Ajukan penarikan kendaraan {{ $item->brand }} {{ $item->model }} dari {{ $pickupLocations->name }}?')">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit"
                                                    class="inline-flex items-center justify-center rounded-lg bg-gray-100 px-4 py-2.5 text-xs font-semibold text-gray-700 transition hover:bg-gray-200 dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500">
                                                    Lihat
                                                </button>
                                            </form>
                                        </td>
                                            ...
                                            <div class="flex flex-col items-center justify-center">
                                                <div
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        ...
                                                        class="h-7 w-7">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            d="M12 6v6l4 2.25M21 12a9 9 0 1 1-18 0Z" />
                                                    </svg>
                                                </div>
                    ...
                    @forelse($vehicles as $item)
                        <div class="rounded-2xl border border-gray-100 bg-white p-4 dark:border-gray-600 dark:bg-gray-700">
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-start justify-between gap-3">
                                        <div class="min-w-0">
                                            ...
                                            <p class="mt-1 text-xs text-gray-400 dark:text-gray-400">
                                                {{ $item->type->name }} · {{ $item->year }} · {{ $item->color }}
                                            </p>
                                            <p class="mt-1 text-xs font-medium text-gray-500 dark:text-gray-300">
                                                {{ $item->plate_number }}
                                            </p>
                            ...
                            <div class="mt-4 grid grid-cols-2 gap-3 text-xs">
                                <div>
                                    <p class="text-gray-400 dark:text-gray-500">Pemilik</p>
                                ...
                                {{-- DATE --}}
                                <div>
                                    <p class="text-gray-400 dark:text-gray-500">Dititipkan</p>
                            ...
                            <div class="mt-4 border-t border-gray-200 pt-3 dark:border-gray-600">
                                <a href="{{ route('vehicle.show', $item->id) }}"
                                    class="flex w-full items-center justify-center rounded-lg bg-gray-100 py-2.5 text-xs font-semibold text-gray-700 transition hover:bg-gray-200 dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
