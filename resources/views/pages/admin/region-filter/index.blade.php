    ...
    <section class="w-full">
        ...
        <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-2xl font-bold tracking-tight text-gray-800 dark:text-white sm:text-3xl">Region Filter
                </h1>
                <p class="mt-1 hidden sm:block text-sm text-gray-500 dark:text-gray-400">Kelola region yang digunakan pelanggan untuk
                    menemukan kendaraan berdasarkan wilayah.</p>
            </div>

            <a href="{{ route('region-filter.create') }}"
        ...
        <div class="mb-6 grid grid-cols-2 gap-4">
            <div class="rounded-2xl bg-white p-5 dark:border dark:border-gray-600 dark:bg-gray-700">
                <div class="flex items-center justify-between gap-4">
                    <div>
                        <p class="text-xs font-medium text-gray-400 dark:text-gray-500">Total Region</p>
                        <p class="mt-2 text-2xl font-bold text-gray-800 dark:text-white">{{ $regionFilters->count() }}</p>
                        <p class="mt-1 text-xs hidden sm:block text-gray-500 dark:text-gray-400">region terdaftar</p>
                    </div>
                    <div
            ...
            <div class="rounded-2xl bg-white p-5 dark:border dark:border-gray-600 dark:bg-gray-700">
                <div class="flex items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-1 text-xs hidden sm:block text-gray-500 dark:text-gray-400">kendaraan dalam region</p>
                    </div>
                    <div
                        class="flex h-11 w-11 items-center justify-center rounded-xl bg-gray-100 text-gray-500 dark:bg-gray-600 dark:text-gray-300">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6"
        ...
        <div class="rounded-2xl bg-white dark:border dark:border-gray-600 dark:bg-gray-700">
            <div class="border-b border-gray-200 p-5 dark:border-gray-600 sm:p-6">
                <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h2 class="text-base font-semibold text-gray-800 dark:text-white">Daftar Region</h2>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Region yang dapat dipilih pelanggan untuk
                            mencari kendaraan.</p>
                    </div>
                    <span class="text-xs text-gray-400 dark:text-gray-500">{{ $regionFilters->count() }} region</span>
                </div>
            </div>
            ...
            <div class="divide-y divide-gray-200 dark:divide-gray-600">
                    ...
                    <div class="flex gap-4 p-5 flex-row items-center sm:p-6">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="mt-1 hidden sm:block text-sm leading-6 text-gray-500 dark:text-gray-400">
                                {{ $region->description ?: 'Tidak ada deskripsi untuk region ini.' }}
                            </p>

                            <p class="mt-2 text-xs text-gray-400 dark:text-gray-500">
                                Dibuat {{ $region->created_at?->format('d M Y, H:i') ?? '-' }}
                            </p>
                        </div>

                        <div class="flex shrink-0 items-center gap-2">
                            <a href="{{ route('region-filter.edit', $region->id) }}"
                ...
                @empty
                    <div class="p-10 text-center">
                        ...
                        <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">Tambahkan region pertama agar pelanggan
