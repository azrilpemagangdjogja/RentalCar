...
@section('content')
    <section class="w-full">
        ...
        <form action="{{ route('region-filter.update', $regionFilter->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="lg:col-span-2">
                    <div class="rounded-2xl bg-gray-50 dark:bg-gray-700">
                        <div class="border-b border-gray-100 p-5 dark:border-gray-600 sm:p-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Perbarui informasi dasar untuk region yang digunakan pada sistem.</p>
                        </div>
                        ...
                        <div class="space-y-5 p-5 sm:p-6">
                            ...
                            <div>
                                <label for="name"
                                    class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-200">Nama Region</label>
                                <input type="text" name="name" id="name"
                                    value="{{ old('name', $regionFilter->name) }}"
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="7"
                                    placeholder="Jelaskan wilayah atau cakupan region ini..."
                                    class="w-full resize-none rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm leading-6 text-gray-800 outline-none transition focus:border-gray-500 focus:ring-2 focus:ring-gray-800/10 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 dark:focus:border-gray-300 dark:focus:ring-white/10">{{ old('description', $regionFilter->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs leading-5 text-gray-500 dark:text-gray-400">
                                    ...
                                    Region yang diperbarui akan digunakan pada menu pencarian kendaraan.
                                </p>
                            </div>
                        </div>
                    </div>
