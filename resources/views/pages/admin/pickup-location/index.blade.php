...
@section('content')
    <section class="w-full">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <div class="sm:flex hidden items-center gap-2 text-sm text-gray-400 dark:text-gray-400">
                    ...
                    <div
                            ...
                            <div class="flex min-w-0 items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <h3 class="truncate text-sm font-semibold text-gray-800 dark:text-white">
                                        {{ $location->name }}</h3>
                                    <p class="truncate text-xs text-gray-500 dark:text-gray-400">{{ $location->address }}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="flex justify-between sm:hidden gap-4">
                            <div class="mt-4 flex-1 min-w-0 sm:mt-0">
                                <p class="mb-1 text-[10px] font-medium text-gray-400 dark:text-gray-500 sm:hidden">Dibuat
                                    Oleh
                                </p>
                                <div class="flex items-center">
                                    <div
                                        class="h-7 w-7 shrink-0 items-center max-w-0 justify-center overflow-hidden rounded-full bg-gray-100 text-gray-500 dark:bg-gray-600 dark:text-gray-300">
                            ...
                            <div class="mt-4 sm:mt-0 flex-1 min-w-0">
                                <p class="mb-1 text-[10px] font-medium text-gray-400 dark:text-gray-500 sm:hidden">
                                    Kendaraan
                                </p>
                                <p class="text-sm text-gray-600 dark:text-gray-300">
                                    {{ $location->vehicles->count() ?? 0 }}
                                </p>
                            </div>

                            {{-- CAPACITY --}}

                            <div class="mt-4 sm:mt-0 flex-1 min-w-o">
                                <p class="mb-1 text-[10px] font-medium text-gray-400 dark:text-gray-500 sm:hidden">
                                    Kapasitas
                                </p>
                                <p class="text-sm text-gray-600 dark:text-gray-300">{{ $location->max_vehicle ?: '-' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <form action="{{ route('pickup-location.destroy', $location->id) }}" method="POST" class="hidden sm:block"
                                onsubmit="return confirm('yakin ingin menghapus {{ $location->name }}? tindakan ini tidak dapat dibatalkan!')">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                                    class="rounded-lg p-2 text-gray-500 transition hover:bg-gray-200 dark:text-gray-300 dark:hover:bg-gray-600"
