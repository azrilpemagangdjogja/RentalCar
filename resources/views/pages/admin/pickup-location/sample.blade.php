            ...
            <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div class="rounded-2xl bg-white dark:bg-gray-700">
                    <div class="border-b border-gray-100 p-5 dark:border-gray-600 sm:p-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Atur apakah lokasi dapat digunakan oleh kendaraan.
                        </p>
                    </div>
                    ...
                    <div class="p-5 sm:p-6">
                        <div class="mb-4 flex items-center justify-between gap-4">
                            ...
                            <span
                                class="rounded-full bg-gray-800 px-3 py-1.5 text-[10px] font-semibold text-white dark:bg-white dark:text-gray-800">
                                {{ $pickupLocation->status }}
                            </span>
                        </div>
                ...
                <div class="rounded-2xl bg-white dark:bg-gray-700">
                    <div class="border-b border-gray-100 p-5 dark:border-gray-600 sm:p-6">
                        <h2 class="text-base font-semibold text-gray-800 dark:text-white">
                            Aksi Pickup Location
                        </h2>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Kelola informasi lokasi dan kendaraan.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-2 p-4 sm:grid-cols-2">
                        ...
                        <a href=""
                            class="flex items-center gap-3 rounded-xl bg-gray-50 px-4 py-3 text-sm font-medium text-gray-700 transition hover:bg-gray-100 dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.8" stroke="currentColor"
                        ...
                        <a href=""
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                class="h-5 w-5 text-gray-500 dark:text-gray-300">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="m16.862 4.487 1.888 1.888M18.75 6.375 9 16.125 5.25 17.25l1.125-3.75 9.75-9.75a1.5 1.5 0 0 1 2.625 1.125Z" />
                            </svg>
                            Edit Informasi
                        </a>
